# Список пунктов изначального ТЗ
...
1. **Пункты №1, №3 и №4 запутаны**. Предположительно, у нас есть две исчислительных меры — **единица товара** (штука) и **товарная позиция** (вид товара — например, некий один продукт).
2. единиц
